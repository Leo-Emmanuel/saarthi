...
class QuestionSchema(Schema):
    ...
    type = fields.String(load_default="text", validate=validate.OneOf(["text", "mcq", "voice"]))
    ...
    grading_config = fields.Dict(load_default=None, allow_none=True)
...
class SubmitAnswerSchema(Schema):
    ...
    tab_violations = fields.List(fields.Raw(), load_default=[])
